...
namespace ProTracking.Infrastructures.Migrations
{
    ...
    [Migration("20231009074104_AddTodoToProject")]
    partial class AddTodoToProject
    {
            ...
            modelBuilder.Entity("ProTracking.Domain.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccountTypeId = 1,
                            Birthday = new DateTime(2023, 10, 9, 14, 41, 4, 384, DateTimeKind.Local).AddTicks(6329),
                        ...
                        new
                        {
                            Id = 2,
                            AccountTypeId = 1,
                            Birthday = new DateTime(2023, 10, 9, 14, 41, 4, 384, DateTimeKind.Local).AddTicks(6343),
                            Email = "hai@gmail.com",
                            EndDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Hoang",
