...
namespace ProTracking.Infrastructures.Migrations
{
    ...
    [Migration("20231009080346_AddAccountTypeToCustomer")]
    partial class AddAccountTypeToCustomer
    {
            ...
            modelBuilder.Entity("ProTracking.Domain.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccountTypeId = 1,
                            Birthday = new DateTime(2023, 10, 9, 15, 3, 46, 324, DateTimeKind.Local).AddTicks(6100),
                        ...
                        new
                        {
                            Id = 2,
                            AccountTypeId = 1,
                            Birthday = new DateTime(2023, 10, 9, 15, 3, 46, 324, DateTimeKind.Local).AddTicks(6116),
                            Email = "hai@gmail.com",
                            EndDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Hoang",
