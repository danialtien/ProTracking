...
namespace ProTracking.Infrastructures.Migrations
{
    ...
    [Migration("20231009120345_AddSeedDataProjectTodoLabel")]
    partial class AddSeedDataProjectTodoLabel
    {
            ...
            modelBuilder.Entity("ProTracking.Domain.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccountTypeId = 1,
                            Birthday = new DateTime(2023, 10, 9, 19, 3, 45, 97, DateTimeKind.Local).AddTicks(216),
                            ...
                            Password = "1234",
                            Phone = "08888888",
                            RegisteredAt = new DateTime(2023, 10, 9, 0, 0, 0, 0, DateTimeKind.Local),
                            Role = 1,
                        ...
                        new
                        {
                            Id = 2,
                            AccountTypeId = 1,
                            Birthday = new DateTime(2023, 10, 9, 19, 3, 45, 97, DateTimeKind.Local).AddTicks(233),
                            Email = "hai@gmail.com",
                            EndDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Hoang",
            ...
            modelBuilder.Entity("ProTracking.Domain.Entities.Todo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Assignee = 1,
                            CreatedBy = 1,
                            EndDate = new DateTime(2023, 10, 16, 19, 3, 45, 97, DateTimeKind.Local).AddTicks(283),
                            IconPriority = "",
                            LabelId = 1,
                            Priority = 5,
                            ProjectId = 1,
                            ReportTo = 0,
                            StartDate = new DateTime(2023, 10, 9, 19, 3, 45, 97, DateTimeKind.Local).AddTicks(283),
                            Status = "In Progress",
                        ...
                        new
                        {
                            ...
                            Assignee = 1,
                            CreatedBy = 1,
                            EndDate = new DateTime(2023, 10, 16, 19, 3, 45, 97, DateTimeKind.Local).AddTicks(287),
                            IconPriority = "",
                            LabelId = 2,
                            Priority = 5,
                            ProjectId = 1,
                            ReportTo = 0,
                            StartDate = new DateTime(2023, 10, 9, 19, 3, 45, 97, DateTimeKind.Local).AddTicks(287),
                            Status = "Todo",
                        ...
                        new
                        {
                            ...
                            Assignee = 1,
                            CreatedBy = 1,
                            EndDate = new DateTime(2023, 10, 16, 19, 3, 45, 97, DateTimeKind.Local).AddTicks(290),
                            IconPriority = "",
                            LabelId = 3,
                            Priority = 5,
                            ProjectId = 1,
                            ReportTo = 0,
                            StartDate = new DateTime(2023, 10, 9, 19, 3, 45, 97, DateTimeKind.Local).AddTicks(289),
                            Status = "In Progress",
