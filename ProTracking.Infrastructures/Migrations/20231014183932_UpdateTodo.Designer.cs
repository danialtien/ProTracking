...
namespace ProTracking.Infrastructures.Migrations
{
    ...
    [Migration("20231014183932_UpdateTodo")]
            ...
            modelBuilder.Entity("ProTracking.Domain.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            AccountTypeId = 1,
                            Birthday = new DateTime(2023, 10, 15, 1, 39, 32, 289, DateTimeKind.Local).AddTicks(1096),
                        ...
                        new
                        {
                            Id = 2,
                            AccountTypeId = 1,
                            Birthday = new DateTime(2023, 10, 15, 1, 39, 32, 289, DateTimeKind.Local).AddTicks(1109),
                            Email = "hai@gmail.com",
                            EndDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            FirstName = "Hoang",
            ...
            modelBuilder.Entity("ProTracking.Domain.Entities.Todo", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Assignee = 1,
                            CreatedBy = 1,
                            EndDate = new DateTime(2023, 10, 22, 1, 39, 32, 289, DateTimeKind.Local).AddTicks(1147),
                            IconPriority = "",
                            LabelId = 1,
                            Priority = 5,
                            ProjectId = 1,
                            ReportTo = 0,
                            StartDate = new DateTime(2023, 10, 15, 1, 39, 32, 289, DateTimeKind.Local).AddTicks(1147),
                            Status = "In Progress",
                        ...
                        new
                        {
                            ...
                            Assignee = 1,
                            CreatedBy = 1,
                            EndDate = new DateTime(2023, 10, 22, 1, 39, 32, 289, DateTimeKind.Local).AddTicks(1152),
                            IconPriority = "",
                            LabelId = 2,
                            Priority = 5,
                            ProjectId = 1,
                            ReportTo = 0,
                            StartDate = new DateTime(2023, 10, 15, 1, 39, 32, 289, DateTimeKind.Local).AddTicks(1152),
                            Status = "Todo",
                        ...
                        new
                        {
                            ...
                            Assignee = 1,
                            CreatedBy = 1,
                            EndDate = new DateTime(2023, 10, 22, 1, 39, 32, 289, DateTimeKind.Local).AddTicks(1154),
                            IconPriority = "",
                            LabelId = 3,
                            Priority = 5,
                            ProjectId = 1,
                            ReportTo = 0,
                            StartDate = new DateTime(2023, 10, 15, 1, 39, 32, 289, DateTimeKind.Local).AddTicks(1154),
                            Status = "In Progress",
